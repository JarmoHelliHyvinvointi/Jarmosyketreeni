...
function startWorkout() {
    ...
    // Tarkista minimirajoitukset
    if (workoutConfig.warmupTime + workoutConfig.cooldownTime < 2) {
        alert('Lämmittely ja jäähdyttely yhteensä vähintään 2 minuuttia!');
        return;
    }
...
// KORJATTU: Update arrow indicator - marginaali poistettu
function updateArrowIndicator() {
    ...
    // TARKISTA tarkasti ilman marginaalia
    if (current < lower) {
        arrowEl.textContent = '↑';
...
// KORJATTU: Initialize app with safe event listeners - VERSIO 1.5.3
window.onload = function() {
    console.log('Sovellus latautuu... v1.5.3');
