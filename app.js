...
let workoutState = {
    ...
    fullUpperPlan: [],
    totalWorkoutTime: 0,
    showPreview: true,  // UUSI: esikatselutila
    previewTimer: null   // UUSI: ajastin
};
...
function generateWorkoutPlan() {
    ...
    workoutState.totalWorkoutTime = totalSeconds; // TÄRKEÄ: tallenna kokonaisaika
}
...
// KORJATTU: Start workout - lisätty esikatselu
function startWorkout() {
    ...
    workoutState = {
        ...
        fullUpperPlan: [],
        totalWorkoutTime: 0,
        showPreview: true,  // NOLLAA esikatselu päälle
        previewTimer: null
    };
    ...
    // UUSI: Ajastin esikatselun poistamiseen
...
// KORJATTU: Initialize app with safe event listeners - VERSIO 1.6.3
window.onload = function() {
    console.log('Sovellus latautuu... v1.6.3');
    
    // KÄYTÄ setTimeout varmistamaan, että DOM on täysin valmis
    setTimeout(() => {
        try {
            ...
            // TARKISTA jokainen elementti
            console.log('saveProfileBtn:', saveProfileBtn);
            console.log('settingsBtn:', settingsBtn);
            console.log('connectHRMBtn:', connectHRMBtn);
            ...
            if (saveProfileBtn) {
                ...
                // Näytä kaikki elementit konsolissa
                console.log('Kaikki button-elementit:', document.querySelectorAll('button'));
            }
