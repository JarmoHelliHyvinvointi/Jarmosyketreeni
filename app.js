...
// KORJATTU: Initialize app with DOMContentLoaded + DEBUG
document.addEventListener('DOMContentLoaded', function() {
    console.log('=== DOMContentLoaded laukesi ===');
    
    // Aseta kaikki funktiot window-objektiin (globaaliksi)
    window.saveProfile = saveProfile;
    window.showProfileScreen = showProfileScreen;
    window.connectHRM = connectHRM;
    window.selectLevel = selectLevel;
    window.startWorkout = startWorkout;
    window.pauseResumeWorkout = pauseResumeWorkout;
    window.stopWorkout = stopWorkout;
    window.resetApp = resetApp;
    window.downloadResults = downloadResults;
    
    // Nyt asetetaan tapahtumankäsittelijät
    const saveProfileBtn = document.getElementById('saveProfileBtn');
    const startWorkoutBtn = document.getElementById('startWorkoutBtn');
    
    console.log('saveProfileBtn:', saveProfileBtn);
    console.log('startWorkoutBtn:', startWorkoutBtn);
    
    if (saveProfileBtn) {
        saveProfileBtn.addEventListener('click', saveProfile);
        console.log('✅ Tallenna Profiili -painike asetettu');
    } else {
    ...
    if (startWorkoutBtn) {
        ...
        console.log('✅ Aloita Treeni -painike asetettu');
    } else {
        console.error('❌ Aloita Treeni -painike puuttuu!');
    }
    
    // Loput tapahtumankäsittelijät
