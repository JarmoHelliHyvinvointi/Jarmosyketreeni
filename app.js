...
function generateWorkoutPlan() {
    ...
    workoutState.totalWorkoutTime = total_seconds;
}
...
// KORJATTU: Start workout - dynaaminen kesto + esikatselu
function startWorkout() {
    ...
    // UUSI: Ajastin esikatselun poistamiseen (3 sekuntia)
...
function updatePhase() {
    ...
    const totalDuration = warmupDuration + totalPeakRest_duration + cooldown_duration;
    
    if (elapsed <= warmupDuration) {
        workoutState.currentPhase = 'warmup';
    } else if (elapsed <= warmupDuration + totalPeakRest_duration) {
...
// KORJATTU: Initialize app - KÄYTÄ window.onload (toimii varmasti)
window.onload = function() {
    console.log('=== window.onload - alustetaan ===');
